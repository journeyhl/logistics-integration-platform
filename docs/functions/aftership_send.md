...
### SendToAfterShip
#### `SendToAfterShip` Pipeline Documentation — [pipelines/aftership_send.py](../../pipelines/aftership_send.py)
```mermaid
...
## Queries
### AcumaticaDb
 - #### [Aftership_Shipments.sql](../../sql/queries/AcumaticaDb/Aftership_Shipments.sql)